...
const Footer = () => {
    return (
        <div className=' bg-pink-100'>
            <footer className="footer mt-4 border-t-2 rounded-xl p-10 bg-pink-50 text-base-content">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-pink-100 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Arts Mania Industries Ltd. <br/>Providing reliable tech since 1992</p>
  </aside> 
